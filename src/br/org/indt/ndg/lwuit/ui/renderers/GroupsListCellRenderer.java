...
public class GroupsListCellRenderer extends DefaultNDGListCellRenderer {

    private static final int PADDING = 5;

    private OpenRosaGroup category;
    private Font catFont = null;
    private Font questFont = null;
    private int fontColor = 0;
    private int touchPadding = 0;

    public Component getListCellRendererComponent(List list, Object value, int index, boolean isSelected) {
        category = (OpenRosaGroup)value;
    ...
    public void paint(Graphics g) {
        ...
        Image img = category.isChanged() ? Resources.check : Resources.question;
        g.drawImage( img,
                     getX() + PADDING,
