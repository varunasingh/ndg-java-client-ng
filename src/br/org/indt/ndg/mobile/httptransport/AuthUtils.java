...
public class AuthUtils {
     ...
     */
    public static Hashtable getQuotedParameters(String args) {
        ...
        Hashtable argsList = new Hashtable();
        String key = "";
        String cur = "";
     ...
     */
    public static String encodeQuotedParameters(Hashtable parameters) {
